                            ...
                            <li class="scrollbar-item">
                                <div class="hero-card has-bg-image"
                                    ...
                                    <div class="card-content">
                                        ...
                                        <a href="shopAll.html" class="btn btn-primary">Shop Now</a>
                        ...
                        <ul class="collection-list">
                            ...
                            <li>
                                <div class="collection-card has-before hover:shine">
                                    ...
                                    <a href="shopAll.html" class="btn-link">
                        ...
                        <ul class="has-scrollbar">
                            ...
                            <li class="scrollbar-item">
                                <div class="shop-card">
                                    ...
                                    <div class="card-banner img-holder" style="--width: 540; --height: 720;">
                                        <img src="./assets/images/product-01.jpg" width="540" height="720"
                                            loading="lazy" alt="Facial cleanser" class="img-cover">

                                        <span class="badge" aria-label="20% off">-20%</span>

                                        <div class="card-actions">
                                            <a href="shopProdect.html">
                            ...
                            <li class="scrollbar-item">
                                <div class="shop-card">
                                    ...
                                    <div class="card-banner img-holder" style="--width: 540; --height: 720;">
                                        <img src="./assets/images/product-02.jpg" width="540" height="720"
                                            loading="lazy" alt="Bio-shroom Rejuvenating Serum" class="img-cover">
                            ...
                            <li class="scrollbar-item">
                                <div class="shop-card">
                                    ...
                                    <div class="card-banner img-holder" style="--width: 540; --height: 720;">
                                        <img src="./assets/images/product-03.jpg" width="540" height="720"
                                            loading="lazy" alt="Coffee Bean Caffeine Eye Cream" class="img-cover">
                            ...
                            <li class="scrollbar-item">
                                <div class="shop-card">
                                    ...
                                    <div class="card-banner img-holder" style="--width: 540; --height: 720;">
                                        <img src="./assets/images/product-04.jpg" width="540" height="720"
                                            loading="lazy" alt="Facial cleanser" class="img-cover">
                            ...
                            <li class="scrollbar-item">
                                <div class="shop-card">
                                    ...
                                    <div class="card-banner img-holder" style="--width: 540; --height: 720;">
                                        <img src="./assets/images/product-05.jpg" width="540" height="720"
                                            loading="lazy" alt="Coffee Bean Caffeine Eye Cream" class="img-cover">
                            ...
                            <li class="scrollbar-item">
                                <div class="shop-card">
                                    ...
                                    <div class="card-banner img-holder" style="--width: 540; --height: 720;">
                                        <img src="./assets/images/product-06.jpg" width="540" height="720"
                                            loading="lazy" alt="Facial cleanser" class="img-cover">
                        ...
                        <ul class="has-scrollbar">
                            ...
                            <li class="scrollbar-item">
                                <div class="shop-card">
                                    ...
                                    <div class="card-banner img-holder" style="--width: 540; --height: 720;">
                                        <img src="./assets/images/product-07.jpg" width="540" height="720"
                                            loading="lazy" alt="Facial cleanser" class="img-cover">
                            ...
                            <li class="scrollbar-item">
                                <div class="shop-card">
                                    ...
                                    <div class="card-banner img-holder" style="--width: 540; --height: 720;">
                                        <img src="./assets/images/product-08.jpg" width="540" height="720"
                                            loading="lazy" alt="Bio-shroom Rejuvenating Serum" class="img-cover">
                            ...
                            <li class="scrollbar-item">
                                <div class="shop-card">
                                    ...
                                    <div class="card-banner img-holder" style="--width: 540; --height: 720;">
                                        <img src="./assets/images/product-09.jpg" width="540" height="720"
                                            loading="lazy" alt="Coffee Bean Caffeine Eye Cream" class="img-cover">
                            ...
                            <li class="scrollbar-item">
                                <div class="shop-card">
                                    ...
                                    <div class="card-banner img-holder" style="--width: 540; --height: 720;">
                                        <img src="./assets/images/product-10.jpg" width="540" height="720"
                                            loading="lazy" alt="Facial cleanser" class="img-cover">
                            ...
                            <li class="scrollbar-item">
                                <div class="shop-card">
                                    ...
                                    <div class="card-banner img-holder" style="--width: 540; --height: 720;">
                                        <img src="./assets/images/product-11.jpg" width="540" height="720"
                                            loading="lazy" alt="Coffee Bean Caffeine Eye Cream" class="img-cover">
                        ...
                        <ul class="banner-list">
                            ...
                            <li>
                                <div class="banner-card banner-card-1 has-before hover:shine">
                                    ...
                                    <a href="shopAll.html" class="btn btn-secondary">Explore More</a>
                            ...
                            <li>
                                <div class="banner-card banner-card-2 has-before hover:shine">
                                    ...
                                    <a href="shopAll.html" class="btn btn-secondary">Shop Sale</a>
                        ...
                        <ul class="flex-list">
                            ...
                            <li class="flex-item">
                                <div class="blog-card">
                                    ...
                                    <figure class="card-banner img-holder has-before hover:shine"
                                        ...
                                        <img src="./assets/images/blog-1.jpg" width="700" height="450" loading="lazy"
                            ...
                            <li class="flex-item">
                                <div class="blog-card">
                                    ...
                                    <figure class="card-banner img-holder has-before hover:shine"
                                        style="--width: 700; --height: 450;">
                                        <img src="./assets/images/blog-2.jpg" width="700" height="450" loading="lazy"
                            ...
                            <li class="flex-item">
                                <div class="blog-card">
                                    ...
                                    <figure class="card-banner img-holder has-before hover:shine"
                                        style="--width: 700; --height: 450;">
                                        <img src="./assets/images/blog-3.jpg" width="700" height="450" loading="lazy"
